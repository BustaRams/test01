...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { category_id: @tour.category_id, description: @tour.description, name: @tour.name, owner_id: @tour.owner_id, start_time: @tour.start_time } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { category_id: @tour.category_id, description: @tour.description, name: @tour.name, owner_id: @tour.owner_id, start_time: @tour.start_time } }
